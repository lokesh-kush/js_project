...
<input class="input-style" type="text" name="transectionId"  placeholder="Enter Transection Id"  >
...
<button class="button" type="submit"   >Proceed to Genrate Bill & Save <i class='far fa-arrow-alt-circle-right'></i></button> 
